...
# تنسيق CSS لجعل العنوان داخل شكل مميز بجانب الرقم
st.markdown("""
    <style>
    ...
    .content-box {
        ...
        overflow: hidden; /* لضمان انحناء زوايا العنوان */
        border: 1px solid #eef0f2;
    }

    /* شكل عنوان الخطوة (داخل البطاقة) */
    .step-header {
...
if choice == "تقديم طلب جديد":
    ...
    with st.container():
        ...
        st.text_input("اكتب الاسم الثلاثي للإقرار")
